...
CREATE TABLE IF NOT EXISTS `heuristica`.`ResolverActividad` (
  ...
  `ComentarioCoevaluacion` VARCHAR(200) NULL,
  ...
  INDEX `fk_Respuestas_ResultadoRubricaAutoevaluacion1_idx` (`ResultadoRubricaAutoevaluacion_idResultadoRubricaAutoevaluacion` ASC),
  INDEX `fk_Respuestas_ResultadoCoevaluacion1_idx` (`ResultadoCoevaluacion_idResultadoCoevaluacion` ASC),
  INDEX `fk_Respuestas_ResultadoRubricaEvaluacion1_idx` (`ResultadoRubricaEvaluacion_idResultadoRubricaEvaluacion` ASC),
  CONSTRAINT `fk_Respuestas_Actividad1`
    FOREIGN KEY (`Actividad_idActividad`)
    REFERENCES `heuristica`.`Actividad` (`idActividad`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Respuestas_ResultadoRubricaAutoevaluacion1`
    FOREIGN KEY (`ResultadoRubricaAutoevaluacion_idResultadoRubricaAutoevaluacion`)
    REFERENCES `heuristica`.`ResultadoRubricaAutoevaluacion` (`idResultadoRubricaAutoevaluacion`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Respuestas_ResultadoCoevaluacion1`
    FOREIGN KEY (`ResultadoCoevaluacion_idResultadoCoevaluacion`)
    REFERENCES `heuristica`.`ResultadoCoevaluacion` (`idResultadoCoevaluacion`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Respuestas_ResultadoRubricaEvaluacion1`
    FOREIGN KEY (`ResultadoRubricaEvaluacion_idResultadoRubricaEvaluacion`)
    REFERENCES `heuristica`.`ResultadoRubricaEvaluacion` (`idResultadoRubricaEvaluacion`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
