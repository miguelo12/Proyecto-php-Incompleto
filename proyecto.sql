...
CREATE TABLE IF NOT EXISTS `heuristica`.`UnidadAprendizaje` (
  ...
  INDEX `fk_UnidadAprendizaje_Seccion1_idx` (`Seccion_idSeccion` ASC),
  CONSTRAINT `fk_UnidadAprendizaje_Seccion1`
    FOREIGN KEY (`Seccion_idSeccion`)
    REFERENCES `heuristica`.`Seccion` (`idSeccion`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `heuristica`.`Rubrica` (
  ...
  INDEX `fk_Rubrica_UnidadAprendizaje1_idx` (`UnidadAprendizaje_idUnidadAprendizaje` ASC),
  CONSTRAINT `fk_Rubrica_UnidadAprendizaje1`
    FOREIGN KEY (`UnidadAprendizaje_idUnidadAprendizaje`)
    REFERENCES `heuristica`.`UnidadAprendizaje` (`idUnidadAprendizaje`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
