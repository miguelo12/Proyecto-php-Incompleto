          ...
          <div class="container">
            <div class="navbar-header">
              <button type="button" class="navbar-toggle collapsed" id="menu-toggle" href="#menu-toggle" aria-expanded="false" aria-controls="navbar">
                ...
                <a class="navbar-brand hidden-xs hidden-sm hidden-md" style="margin-left: 10px" href="indexAdmin.php"><img src="img/logo.PNG" alt="" height="100" width="200"/></a>
                <a class="navbar-brand hidden-xs hidden-lg" style="margin-left: 10px" href="indexAdmin.php"><img src="img/logo.PNG" alt="" height="90" width="180"/></a>
                <a class="navbar-brand hidden-md hidden-sm hidden-lg" style="margin-left: 10px" href="indexAdmin.php"><img src="img/logo.PNG" alt="" height="75" width="110"/></a>
            </div>
